...
@section('page-contents')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{route('admin.master-price.update', $masterprice->id)}}" method="POST">
                    @method('PATCH')
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="pricing_level" name="pricing_level"
                                value="{{ $masterprice->pricing_level}}">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="Price">Price</label>
                            <input type="text" class="form-control" id="price" name="price"  value="{{ $masterprice->price}}">
                        </div>
                    </div>
