...
@section('page-contents')
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action={{ route('admin.financial-year.update', $financial_year) }}>
                    @method('PATCH')
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea type="text" class="form-control" id="comments" name="comments" placeholder="Comments">{{  $financial_year->comment  }}</textarea>
                        </div>
                    </div>
