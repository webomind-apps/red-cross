                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTable" width="100%">
                                                ...
                                                <thead>
                                                    <th valign="top" width="100%" class="kmTextContent">
                                                        ...
                                                        <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">by online Payment towards college registration fees of 
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: bold; font-size: 16px; margin-left: 10px;font-style: italic; ">
                                                               Rs. {{$college_registration_annual_fee}} (Rs. {{ $college_registration_annual_fee_amount}})
                                                            </span> 
                                                        </p>
                                                        <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">and student membership fees of
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: bold; font-size: 16px; margin-left: 10px;font-style: italic; ">
                                                                Rs. {{$college_student_memebership_fee}} (Rs. {{$college_student_memebership_fee_amount}})
                                                            </span> 
                                                            <br>
                                                            {{-- <span style="border-bottom: 2px dotted #1d1d1d; font-weight: bold; font-size: 16px; margin-left: 10px;font-style: italic; ">
                                                                ( {{$no_of_students_paid}} students * Rs.{{$college_student_memebership_fee_amount}} ) + Rs.{{ $college_registration_annual_fee_amount }}
                                                            </span>  --}}
                                                        </p>
                                                    </th>
