                                            ...
                                            <td class="kmTableBlockInner" valign="top" >
                                              <table align="center" border="0" cellpadding="0" cellspacing="0" class="kmTable" width="100%">
                                                <thead>
                                                  <tr>
                                                    <th valign="top" class="kmTextContent" style="text-align: right;">
                                                        No: <span style="font-size: 22px; padding-left: 10px; border-bottom: 2px dotted #1d1d1d;"> {{$receipt_no}}</span>
                                                    </th>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTable" width="100%">
                                                ...
                                                <thead>
                                                    <th valign="top" width="100%" class="kmTextContent">
                                                        ...
                                                        <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial;">Online Payment towards JRC examination fees 
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: 400; font-size: 16px; margin-left: 10px; ">
                                                                Rs. {{ $jrc_exam_fees}}
                                                            </span> 
                                                        </p>
                                                        <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial;">Book fees 
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: 400; font-size: 16px; margin-left: 10px; ">
                                                                Rs. {{$book_fees}} 
                                                            </span> 
                                                        </p>
