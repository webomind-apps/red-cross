                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTable" width="100%">
                                                ...
                                                <thead>
                                                    <th valign="top" width="100%" class="kmTextContent">
                                                        ...
                                                        <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">by online Payment towards JRC examination fees of 
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: bold; font-size: 16px; margin-left: 10px;font-style: italic; ">
                                                               Rs. {{$jrc_exam_fee}} (Rs. {{ $jrc_exam_fee_amount}})
                                                            </span> 
                                                        </p>
                                                        <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">and books fees of
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: bold; font-size: 16px; margin-left: 10px;font-style: italic; ">
                                                                Rs. {{$book_fee}} (Rs. {{$book_fee_amount}})
                                                            </span> 
                                                            <br>
                                                            <span style="border-bottom: 2px dotted #1d1d1d; font-weight: bold; font-size: 16px; margin-left: 10px;font-style: italic; ">
                                                                ( {{$total_no_of_students}} students * Rs.{{$jrc_exam_fee}}  + Rs.{{ $no_of_students_buying_book }} students * {{ $book_fee }} )
                                                            </span> 
                                                        </p>
                                                    </th>
