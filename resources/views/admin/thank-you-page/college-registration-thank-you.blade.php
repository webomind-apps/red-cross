                                             ...
                                             <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTable" width="100%">
                                                 ...
                                                 <thead>
                                                     <th valign="top" width="100%" class="kmTextContent">
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial;">
                                                             <b>The Headmaster,<b><br>
                                                             {{ $name }},<br>
                                                             {{ $address }},<br>
                                                             {{ $taluk }} {{ $district }} - {{ $pin_code }}
                                                         </p>
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                                                             <b>Dear Sir / Madam,</b>
                                                         </p>
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                                                           <center><b>Sub :- Registration of college for Junior Red Cross Ref:- Nill Datd:-Nill</b></center><br>
                                                           <center>*******************</center><br>
                                                         </p>
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                                                             We acknowledge with thanks the receipt of Rs.{{ $total_paid }}/- ({{ $total }}) paid through online <b>No-{{$receipt}} Dated: {{ $transaction_date }} 
                                                             </b> towards Registration fee for Junior Red Cross wing of Indian Red Cross
                                                             Society for the year {{ $current_year_name }}
                                                         </p>
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                                                           We enclosed here <b>with Receipt no-{{$receipt}} Dtd :{{ $transaction_date }}, for Rs.{{ $total_paid }}/- ({{ $total }})</b>
                                                         </p>
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                                                           Further, we request you to renew the junior red cross unit and
                                                           conduct its activities at your college every year and extend your co-operation to
                                                           organize programmes /activities under Indian red Cross society.
                                                         </p>
                                                         <p style="text-align: left; padding-left: 20px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                                                             Thanking you,<br><br>
                                                         </p><br><br>
                                                         <b><p style="float: right">
                                                           <img src="{{ public_path("storage/{$signature}") }}" height="50px" alt="" srcset="" style="text-align: center;"><br>
                                                           Yours truly<br>
                                                           {{$signature_name}}<br>
                                                           General Secretary
                                                         </p></b>
