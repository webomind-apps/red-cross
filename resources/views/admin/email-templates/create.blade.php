                ...
                <form method="POST" action={{ route('admin.email-templates.store') }}>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="email_body" name="email_body" placeholder="Email body">
                        </div>
                       
                        <div class="form-group col-md-12">
                            <label for="inputAddress2">To mails</label>
                            <input type="text" class="form-control" id="emails_to" name="emails_to" placeholder="To mails">
                        </div>
                    </div>
