            ...
            <tbody>
                <tr>
                    ...
                    <th valign="top" width="100%" class="kmTextContent">
                        ...
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            Dise code/School code : <b>{{ $request->dise_code }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            School name : <b>{{ $request->school_name }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                        ...
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            No. of students in 8th Std : <b>{{ $request->no_of_students_class_eight }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            No. of students in 9th Std : <b>{{ $request->no_of_students_class_nine }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            No. of students in 10th Std : <b>{{ $request->no_of_students_class_ten }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                        ...
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            School registration annual fee : <b>{{ $request->school_registration_annual_fee }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
                            Student membership fee : <b>{{ $request->school_student_memebership_fee }}</b>
                        </p>
                        <p
                            style="text-align: left; padding-left: 18px; font-size: 17px;font-family:Helvetica, Arial; font-weight: 400;">
