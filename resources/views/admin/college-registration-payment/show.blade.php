    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.college-registration-payment.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $college_registration->dise_code }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $college_registration->college_name }}"
                                readonly>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputAddress">District</label>
                            <input type="text" class="form-control"value="{{ $college_registration->district }}" readonly>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputAddress2">Taluk</label>
                            <input type="text" class="form-control" value="{{ $college_registration->district }}"
                                readonly>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputAddress">Pin Code</label>
                            <input type="text" class="form-control" value="{{ $college_registration->pin_code }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" value="{{ $college_registration->phone_number }}"
                                readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputAddress">Mail Id</label>
                            <input type="text" class="form-control" value="{{ $college_registration->email }}" readonly>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputAddress">Address</label>
                            <input type="text" class="form-control" value="{{ $college_registration->address }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="{{ $college_registration->councellor_name }}"
                                readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputAddress2">Phone No</label>
                            <input type="text" class="form-control" value="{{ $college_registration->councellor_phone }}"
                                readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputAddress2">Email</label>
                            <input type="text" class="form-control" value="{{ $college_registration->councellor_email }}"
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" id="no_of_students_in_first_puc"
                                value="{{ $college_registration->no_of_students_in_first_puc }}" readonly>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputPassword4">9th Student</label>
                            <input type="number" class="form-control" id="no_of_students_in_second_puc"
                                value="{{ $college_registration->no_of_students_in_second_puc }}" readonly>
                        </div>
                        
                        <div class="form-group col-md-3">
                            <label for="inputAddress2">Total Student</label>
                            <input type="number" class="form-control" id="total_students"
                                value="{{ $college_registration->total_students }}" readonly>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="college_registration_annual_fee"
                                value="{{ $college_registration->college_registration_annual_fee }}" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputAddress">Student membership fee</label>
                            <input type="text" class="form-control" id="college_student_memebership_fee"
                                value="{{ $college_registration->college_student_membership_fee }}" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="inputAddress">Number of students paid</label>
                            <input type="text" class="form-control" id="no_of_students_paid"
                                value="{{ $college_registration->no_of_students_paid }}" readonly>
                        </div>
                    </div>
                    ...
                    @foreach ($balances as $index => $balance)
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <h6 style="font-size: 12px">Total students* student memebership fee + college registration
                                    fee</h6>
                            </div>
                            <div class="form-group col-md-2">
                    ...
                    @foreach ($datas as $index => $data)
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-1 my-auto" >
                                <a href="{{ asset("college-pdf/$data->invoice_pdf_path") }}" target="_blank"><button
                                        type="button" class="btn btn-sm bg-paid mt-3" style="font-size: 9px">Download receipt</button>
                                </a>                              
                            </div>
                            <div class="form-group col-md-1 my-auto" >
                                <a href="{{ asset("college-thank-you-pdf/$data->thankyou_pdf_path") }}" target="_blank"><button
                                        type="button" class="btn btn-sm bg-paid  mt-3" style="font-size: 9px">Download thank you page</button>
                                </a>                               
                            </div>
                            <div class="form-group col-md-1 my-auto" >
                                <a href="{{ asset("payment-form-pdf/$data->form_print_pdf") }}" target="_blank"><button
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control" id="convenience" name="convenience"
                                value="{{ $college_registration->mode_of_payment }}" readonly>
                        </div>
                        <div class="form-group col-md-2">
                            <label for="inputAddress2">Last transaction date</label>
                            <input type="text" class="form-control" id="total_to_be_paid" name="total_to_be_paid"
                                value="{{ $college_registration->transaction_date }}" readonly>
                        </div>
                       
                    </div>
                </form>

                {{-- <a href="{{ route('admin.college-registration-payment.index') }}">
                ...
                <a
                href="{{ route('admin.college-registration-payment.index') }}"><button
