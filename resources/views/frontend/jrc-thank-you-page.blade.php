                ...
                <div class="col-lg-10 bg-light p-5 mx-auto text-center">
                    ...
                    <div class="main-content">
                        ...
                        <p class="main-content__body">
                            Thank you,
                            You have successfully paid <b>JRC Examination fees Rs.</b> + <b>student membership fees Rs. for  students</b> + <b>convenience fees of Rs.</b> as total amount of <b>Rs.</b> for the year
                            <b></b>. <br><br>
                            The receipt has been mailed to <span><span> and </span> </span>.
                            <br>
                    ...
                    <div>
                        <a href="{{ asset("jrc-exam-pdf/$fileName") }}" target="_blank">
                            <span>Download Receipt</span>
                        </a>
                    </div>
                    <div>
                        <a href="{{ asset("jrc-exam-thank-you-pdf/$fileName1") }}" target="_blank">
                            <span>Download thank you receipt</span>
                        </a>
                    </div>
                    <div class="col-lg-3 mt-5 mx-auto">
                        <a href="{{ route('jrc-exam-form') }}" class="btns"><span>Back to registration form</span></a>
                    </div>
