                ...
                <div class="col-lg-10 bg-light p-5 mx-auto text-center">
                    ...
                    <div class="main-content">
                        ...
                        <p class="main-content__body">
                            Thank you,
                            You have successfully paid <b>College registration fees Rs.{{ $college_registration_annual_fee }}</b> + <b>student membership fees Rs.{{ $college_student_memebership_fee }} for {{ $no_of_students_paid }} students</b> + <b>convenience fees of Rs.{{ $convenience_amount }}</b> as total amount of <b>Rs.{{ $amount }}</b> for the year
                            <b>{{ date('Y') }}</b>. <br><br>
                    ...
                    <div>
                        <a href="{{ asset("college-pdf/$fileName") }}" target="_blank">
                            <span>Download Receipt</span>
                        </a>
                    </div>
                    <div>
                        <a href="{{ asset("college-thank-you-pdf/$fileName1") }}" target="_blank">
                            <span>Download thank you receipt</span>
                        </a>
                    </div>
                    <div class="col-lg-3 mt-5 mx-auto">
                        <a href="{{ route('college-registration-form') }}" class="btns"><span>Back to college registration form</span></a>
                    </div>
                </div>
            </div>
        </div>
