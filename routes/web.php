...
Route::get('jrc-exam-payment-page', [JrcExaminationController::class, 'payment'])->name('jrc-payment-page');
Route::get('payment-success', [SchoolRegistrationController::class, 'payment_success'])->name('payment-success');
Route::get('jrc-exam-payment-success', [JrcExaminationController::class, 'payment_success'])->name('jrc-exam-payment-success');
Route::get('invoice', [SchoolRegistrationController::class, 'invoice'])->name('invoice');
Route::get('invoice-download', [SchoolRegistrationController::class, 'invoice_download'])->name('invoice-download');
